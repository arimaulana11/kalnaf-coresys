...
-- CreateIndex
CREATE INDEX "inventory_stock_store_id_idx" ON "inventory_stock"("store_id");

-- CreateIndex
CREATE INDEX "idx_stock_variant_id" ON "inventory_stock"("product_variant_id");

-- CreateIndex
CREATE INDEX "idx_price_history_variant_id" ON "price_history"("product_variant_id");

-- CreateIndex
CREATE INDEX "idx_transaction_items_transaction_id" ON "transaction_items"("transaction_id");

-- CreateIndex
CREATE INDEX "idx_transaction_items_variant_id" ON "transaction_items"("product_variant_id");
...
-- CreateIndex
CREATE INDEX "tenant_addons_addon_id_idx" ON "tenant_addons"("addon_id");
...
-- AddForeignKey
ALTER TABLE "inventory_stock" ADD CONSTRAINT "inventory_stock_product_variant_id_fkey" FOREIGN KEY ("product_variant_id") REFERENCES "product_variants"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
